        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-300">
              This is the richer migration pattern: multiple linked views,
              parameter controls, and deterministic computation, all without the
              old fetch-plus-inline-script loop.
            </p>
          </div>
          <button
            type="button"
