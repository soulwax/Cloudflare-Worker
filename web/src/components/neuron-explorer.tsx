        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-300">
              This is the simplest stable migration target: deterministic
              physiology, local computation, and a typed UI state model instead
              of imperative template scripts.
            </p>
          </div>
          <button
            type="button"
